...
// k: 2 检索2个相似的文档,retriever.invoke(question) 返回2个相似的文档
// retriver: 检索器，可以传入问题，返回相似的文档
...
for (const question of questions) {
    ...
    // scoreResults: 检索到的文档的相似度评分
    // 为啥既要retrievedDocs又要scoreResults？
    // 更好的写法是：只保留 scoreResults，从里面同时取 doc 和 score，就不需要 retrievedDocs 了
